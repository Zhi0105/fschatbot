...
(function() {
    ...
    firebase.textContent = `
          import { initializeApp } from "https://www.gstatic.com/firebasejs/10.13.1/firebase-app.js";

          const firebaseConfig = {
            apiKey: "AIzaSyAKVe1zlFfvWACzLugs6zWMDLapod9D2pY",
            authDomain: "fschat-f02ce.firebaseapp.com",
            databaseURL: "https://fschat-f02ce-default-rtdb.asia-southeast1.firebasedatabase.app",
            projectId: "fschat-f02ce",
            storageBucket: "fschat-f02ce.appspot.com",
            messagingSenderId: "208904497798",
            appId: "1:208904497798:web:1d6d59e97da83ab4d9bf07",
            measurementId: "G-LBRZG07D2E"
          };
      ...
      document.head.appendChild(firebase); // or document.body.appendChild(script);
